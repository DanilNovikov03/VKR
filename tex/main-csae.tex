...
\title{ПРОЕКТИРОВАНИЕ ВЕБ-ПРИЛОЖЕНИЯ ВИЗУАЛИЗАЦИИ ДАННЫХ О ИСТОРИЧЕСКИХ ДЕЙСТВИЯХ «ПАЛАНТИР»} % Проектирование веб-приложения визуализации данных о исторических действиях «ПАЛАНТИР»
\author{Д.\,А.~Новиков}
\groupnumber{5.205-2}
\GradebookNumber{29}
...
\UDC{004.9}
\docname{БР 09.03.01}
\worktype{Бакалаврская} % Бакалаврская / Магистерская
\workgrade{БАКАЛАВРА} % БАКАЛАВРА / МАГИСТРА
...
%\abstractEN{}
\keysRU{веб-приложение, исторические военные конфликты, картографическая визуализация, C\#, .NET Core, ASP.NET Core, PostgreSQL, PostGIS, GeoJSON, серверный API}
